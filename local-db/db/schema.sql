...
-- Note: the Ask page's ask_log / ask_chat tables live in a separate database
-- (ASK_DB_PATH, default ask.db) so they persist across image rebuilds — see
-- server/index.js. They are intentionally not part of this baked schema.
